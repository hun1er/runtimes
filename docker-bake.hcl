...
target "_common" {
  ...
  labels = {
    "org.opencontainers.image.vendor"   = "Runtime Project"
    "org.opencontainers.image.licenses" = "MIT"
    "org.opencontainers.image.source"   = notequal(REGISTRY, "") ? "https://${REGISTRY}" : ""
...
target "base-debian" {
  ...
  labels = {
    "org.opencontainers.image.title"       = "Base Runtime (Debian)"
...
target "goldsrc-debian" {
  ...
  labels = {
    "org.opencontainers.image.title"       = "GoldSrc Runtime (Debian)"
    "org.opencontainers.image.description" = "32-bit runtime environment for GoldSrc dedicated game servers"
  }
}
